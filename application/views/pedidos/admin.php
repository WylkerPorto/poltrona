...
<div class="container-fluid mt-5" ng-controller="rhome">
            ...
            <?php foreach ($pedidos as $pedido): ?>
                <tr id="u<?= $pedido->id; ?>">
                    ...
                    <td>
                        ...
                        <button class="btn btn-outline-success material-icons" title="processar pedido"
                                ng-click="promover('<?= $pedido->id; ?>')">
                            check_circle
                        </button>
