...
<div class="container" ng-controller="sledit">
    <p class="text-center">Selecione as imagens que aparecerão no slider da vitrine.</p>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-12">
            ...
            <input type="text" name="url_sl3" class="form-control" placeholder="Link" value="<?= ($itens->url_sl3) ? $itens->url_sl3 : null ; ?>" id="url_sl3">
            <input type="file" name="img3" accept=".jpg, .png, .gif">
        </div>
                ...
                <?php if ($item): ?>
                    <?php if (($k == 'sl1') || ($k == 'sl2') || ($k == 'sl3')): ?>
                        <div class="col-12 col-md-4" id="sl<?= $i; ?>">
                            ...
                            <div class="row">
                                <button class="btn btn-outline-danger material-icons w-100" ng-click="deletar(1,'<?= $item ?>')">
                                    delete
                                </button>
                            </div>
                        </div>
